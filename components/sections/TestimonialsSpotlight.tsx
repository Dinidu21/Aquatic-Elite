...
const TestimonialsSpotlight: React.FC = () => {
    // Get the first 3 testimonials for spotlight
            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-slate-600 text-lg max-w-2xl mx-auto">
                        Real stories from parents and students who have experienced transformational
                        growth in their swimming journey with us.
                    </p>
                </div>
                            ...
                            <div className="border-t border-slate-200 pt-6">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-slate-500 mt-1">{testimonial.studentAge} years old</div>
                                    </div>
                                </div>
                            </div>
