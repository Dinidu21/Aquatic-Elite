...
export const testimonialsData: Testimonial[] = [
  {
    ...
    studentName: "Emma Chen",
    quote:
      "Sarah transformed Emma from a recreational swimmer into a national champion. Her dedication, expertise, and genuine care for each athlete is extraordinary. Emma not only improved her times dramatically but gained confidence that extends into every area of her life.",
    rating: 5,
    date: "2024-03-15",
    relationship: "Parent",
    featured: true,
  ...
  },
  {
    ...
    studentName: "Marcus Johnson",
    quote:
      "Working with Sarah has been life-changing for Marcus. Her scientific approach to training combined with her ability to motivate and inspire has taken his swimming to levels we never thought possible. The Olympic Trials qualification speaks for itself.",
    rating: 5,
    date: "2024-02-28",
    relationship: "Parent",
    featured: true,
  ...
  },
  {
    ...
    studentName: "Sofia Rodriguez",
    quote:
      "Sofia loves training with Sarah! The positive environment and personalized attention have made such a difference. Sarah doesn't just coach swimming - she mentors young athletes and helps them become better people.",
    rating: 5,
    date: "2024-01-20",
    relationship: "Parent",
    featured: false,
  ...
  },
  {
    ...
    studentName: "Alex Thompson",
    quote:
      "Sarah's coaching changed my entire perspective on swimming and competition. Her mental training techniques and race strategy development helped me achieve my world championship medal. I'm grateful for her guidance both in and out of the pool.",
    rating: 5,
    date: "2023-12-10",
  ...
  },
  {
    ...
    studentName: "Maya Patel",
    quote:
      "Sarah's ability to work with young athletes is remarkable. Maya has flourished under her coaching, developing not just as a swimmer but as a confident young woman. The individual attention and care Sarah provides is unmatched.",
    rating: 5,
    date: "2024-02-05",
    relationship: "Parent",
    featured: false,
...
export const programsData: Program[] = [
  {
    ...
    longDescription:
      "Our most advanced program designed for swimmers with national-level aspirations. Includes technical refinement, race strategy, mental preparation, and strength conditioning. Limited to 8 athletes for maximum individual attention.",
    ...
    goals: ["National championship qualification", "Technique optimization", "Mental toughness development", "College recruitment preparation"],
    featured: true,
  },
  {
    id: "prog-002",
    ...
    longDescription:
      "Perfect for swimmers looking to take their competitive swimming to the next level. Focus on technique refinement, race preparation, and consistent improvement across all strokes.",
    ...
    goals: ["Regional championship qualification", "Stroke technique improvement", "Race strategy development", "Consistent time drops"],
    featured: true,
  },
  {
    id: "prog-003",
    ...
    longDescription:
      "Intensive technical training program that breaks down each stroke into component parts. Perfect for swimmers who want to build a solid foundation or refine existing technique.",
    ...
    goals: ["Master all four strokes", "Improve efficiency", "Build proper habits", "Increase speed through technique"],
    featured: false,
  },
  {
    id: "prog-004",
    ...
    longDescription:
      "Fun, engaging program that introduces young swimmers to competitive swimming fundamentals while building confidence and love for the sport.",
    ageGroup: "8-12 years",
    level: "Beginner",
    features: [
      "Fun-based learning",
    ...
    goals: ["Develop stroke fundamentals", "Build water confidence", "Introduction to competition", "Foster love of swimming"],
    featured: false,
  },
];
...
export const faqData: FAQ[] = [
  {
    ...
    answer:
      "I work with swimmers from age 8 through college level (18+). Programs are specifically designed for different age groups and skill levels to ensure optimal development and safety.",
    category: "General",
    featured: true,
  },
  {
    ...
    answer:
      "The Elite Program requires state-level qualifying times and minimum 2 years competitive experience. We also conduct an assessment to ensure the program is the right fit for the athlete's goals and commitment level.",
    category: "Programs",
    featured: true,
  },
  {
    ...
    answer:
      "Yes! Nutrition is a crucial component of athletic performance. I provide general nutrition education and can connect families with certified sports nutritionists for more detailed meal planning.",
    category: "Programs",
    featured: false,
  },
  {
    ...
    answer:
      "I understand that young athletes have busy schedules. We work together to find solutions, including makeup sessions when possible and modified training plans during peak academic periods.",
    category: "Schedule",
    featured: false,
  },
  {
    ...
    answer:
      "My goal is to foster a lifelong love of swimming. If a swimmer is struggling with motivation, we'll work together to address concerns and find ways to reignite their passion for the sport.",
    category: "General",
    featured: true,
  },
];
